function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 sm:p-4 md:p-8 max-w-sxs md:max-w-sm mx-auto,my-20 rounded-lg, shadow-lg text-center"  >
      <img src="https://via.placeholder.com/150" alt="User" className="rounded-full sm:w-24 sm:h-24 md:w-36 md:h-36 mx-auto "/>
      <h1 className="sm:text-lg md:text-x1 text-blue-800 my-4" >John Doe</h1>
